...
public class TownLawDescription extends AdministratingUnitLawDescription{
    ...
    public static final RuleDescription nationsID = new RuleDescription(RuleType.UUID, "The id of the nation the town is in", true, () -> null);
    public static final String nationsIDLabel = "nationId";
    public static final RuleDescription listOfDistrictsIDs = new RuleDescription(RuleType.LISTOFUUID, "The list of UUIDs of districts which belong to the town", false, ArrayList<UUID>::new);
    public static final String listOfDistrictsIDsLabel = "listOfDistrictsIDs"; 
    public static final RuleDescription setOfPlayerMembers = new RuleDescription(RuleType.SETOFPLAYERACOUNT, "The accounts of citizens belonigng to the town", false, HashSet<PlayerAccount>::new);
    public static final String setOfPlayerMembersLabel = "setOfPlayerMembers";
    public static final RuleDescription setOfAIMembers = new RuleDescription(RuleType.SETOFUUID, "The UUIDs of citizens belonigng to the town", false, HashSet<UUID>::new);
