...
public class AdministratingUnitLawDescription extends LegalOrganisationLawDescription {
    public static final RuleDescription mapColour = new RuleDescription(RuleType.COLOUR, Text.literal("Colour"), "The colour the territory claimer has on the map", false, () -> new Colour(0));
