...
public class NationLawDescription extends AdministratingUnitLawDescription {
    public static final RuleDescription capitalsID = new RuleDescription(RuleType.UUID, Text.literal("Capital's ID"), "The id of the nation's capital", true, () -> null);
    public static final String capitalsIDLabel = "capitalsId"; 
    public static final RuleDescription listOfProvincesIDs = new RuleDescription(RuleType.LISTOFUUID, Text.literal("Provinces' IDs"), "IDs of provinces which belong to the nation", false, ArrayList<UUID>::new);
    public static final String listOfProvincesIDsLabel = "listOfProvincesID";
    public static final RuleDescription listOfTownsIDs = new RuleDescription(RuleType.LISTOFUUID, Text.literal("Towns' IDs"), "IDs of towns which belong to the nation", false, ArrayList<UUID>::new);
    public static final String listOfTownsIDsLabel = "listOfTownsIDs";
    public static final RuleDescription townProvinceRegistry = new RuleDescription(RuleType.MAPOFUUIDS, Text.literal("Town-province registry's ID"), "Contains the UUID of a town and a UUID of a province it belongs to", false, HashMap<UUID, UUID>::new);
